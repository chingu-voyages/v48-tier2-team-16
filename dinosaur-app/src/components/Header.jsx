          ...
          <div className="col-md-9 d-flex justify-content-end">
            <nav className="navbar navbar-expand">
              ...
              >
                ...
                <li className="nav-item">
                  <a className="nav-link text-white" href="#diet">
                    Diet Chart <span className="mx-2">|</span>
                  </a>
                </li>
                <li className="nav-item">
      ...
      <div className="container mt-3">
        <div className="row">
          <div className="col-md-12">
            <h1
              className="display col-md-3 mb-4"
              style={{
            ...
            <p
              className="lead col-md-4 mb-4"
              style={{ fontFamily: "Rambla, sans-serif", fontWeight: "400" }}
            >
